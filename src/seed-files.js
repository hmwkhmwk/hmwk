...
const assignments = [
  {
    ...
    description_for_homework: 'Write up a potion to help students focus on learning',
  ...
  {
    name: 'Enchanments I',
    description_for_homework: 'Find out which are the most popular enchanments in 2020',
